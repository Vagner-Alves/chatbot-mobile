...
fun AboutScreen() {
    Surface(
        ...
        Column(
            ...
            Text(text = "Sobre o Aplicativo", style = MaterialTheme.typography.headlineMedium)
            Text(text = "Este é um aplicativo de chat com IA.", style = MaterialTheme.typography.bodyLarge)
            Text(text = "Versão: 1.0.0", style = MaterialTheme.typography.bodyLarge)
            // TODO: Add more about information
        }
    }
}
